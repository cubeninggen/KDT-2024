...
def make_wordcloud(title_list, stopwords, word_count):
    ...
    wordcloud= WordCloud(font_path=path, width=800, height=600,background_color="white", max_font_size=200,repeat=True,colormap='inferno', mask=img_mask)
...
if __name__ == '__main__':
    search_word= "ChatGPT"  # 검색어지정
    title_list= []
    stopwords= [search_word, '데이터'] # wordcloud에서제외할단어
